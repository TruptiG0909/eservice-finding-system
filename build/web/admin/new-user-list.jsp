    ...
    <div style=" width: 100%; height: 500px;">
       <%@ include file="sidebar.jsp" %>
        <div style="width: 80%; float: left; margin-left:10px;">
            <a href="#"><button disabled style="width: 100%; font-size: large; background-color:darkgreen; color: #fff; padding: 10px 5px 10px 5px;">New Service User Registration</button></a>
            <br><br>

            <table cellpadding="10" width="100%" style="">
                <tr style="background-color:#096e9a; padding:10px; color:#fff;"><th style="padding:10px">Username</th><th>Full name</th><th>Address</th><th>Mobile No.</th><th>Email-ID</th><th>Action</th></tr>
               <%
          Database db=new Database();
          ResultSet rs=db.select_row("select * from user where user_role='user' and status=0");
          if(rs!=null){
              while(rs.next()){
                  int id=rs.getInt("id");
