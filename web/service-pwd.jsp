...
<main class="main">
        ...
        <section id="contact-2" class="contact-2 section">
				<div class="container">
                        ...
                        %><br><br><br>
                                    <h4 style="text-align:left;"><p style="padding:0px 10px;">My Profile <a style="float:right; padding-right:5px;" href="service-profile.jsp">Change Profile</a></p></h4>
                                  <div class="col-md-12" style="text-align:left;">
                                      <div class="mail-grids">
                                          <form action="includes/WebService.jsp" method="post" name="editpwd">
                                              <input type="hidden" name="action" value="updateservicepwd"/>
                                              <div class="contact-form">
                                                  ...
                                                  <div class="col-md-12">
                                                      <div class="col-md-2">
                                                          ...
                                                          <input type="button" onclick="updatepwd();"  class="btn btn-primary" value="Update Password"/>
                                                          <br><br><br><br><br>
                                                      </div>
                                                  </div>
