...
//    out.println(contentType);
    if((contentType!=null) && (contentType.indexOf("multipart/form-data")>=0)){
        ...
        //out.println(file);
        //out.println(endPos);
        String saveFile1="/root/Documents/PRO/nearservice/web/uploads/"+saveFile;
        ...
        try{
            ...
            int res=db.update_delete("update service_provider_profile set image='"+saveFile+"' where user_id="+us);
            if(res>0){
